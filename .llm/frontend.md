...
The `keloc-notes` frontend is a reactive, domain-driven application built on **Svelte 5**. It prioritizes a clean separation between **Data Persistence**, **Domain State**, **Business Logic**, and **UI Presentation**.
...
- **Performance**: Note content is _not_ stored here; it is fetched on-demand from IndexedDB to keep the store lightweight.
