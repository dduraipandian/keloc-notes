# Keloc Notes Architectural Overview

## Project Mission

`keloc-notes` is a high-performance, local-first desktop markdown application built for speed, privacy, and native-feeling interactions.
...
`keloc-notes` implements a local full-text search using `MiniSearch`.
